    ...
    public partial class OperationsHistoryAPI : ServiceClient<OperationsHistoryAPI>, IOperationsHistoryAPI
    {
        ...
        public async Task<HttpOperationResponse<object>> GetByClientIdWithHttpMessagesAsync(string clientId, int take, int skip, IList<string> operationTypes = default(IList<string>), string assetId = default(string), string assetPairId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("operationTypes", operationTypes);
            ...
            if (operationTypes != null)
            {
                ...
                {
                    _queryParameters.Add(string.Format("operationTypes={0}", System.Uri.EscapeDataString(string.Empty)));
                }
                else
                {
                    foreach (var _item in operationTypes)
                    {
                        _queryParameters.Add(string.Format("operationTypes={0}", System.Uri.EscapeDataString("" + _item)));
                    }
                }
            }
            if (assetId != null)
        ...
        public async Task<HttpOperationResponse<HistoryOperation>> GetByOperationIdWithHttpMessagesAsync(string walletId, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetByOperationId", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/OperationsHistory/wallet/{walletId}/operation/{operationId}").ToString();
            _url = _url.Replace("{walletId}", System.Uri.EscapeDataString(walletId));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<HistoryOperation>> ApiOperationsHistoryClientByClientIdOperationByOperationIdDeleteWithHttpMessagesAsync(string clientId, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (clientId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "clientId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("operationId", operationId);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "ApiOperationsHistoryClientByClientIdOperationByOperationIdDelete", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/OperationsHistory/client/{clientId}/operation/{operationId}").ToString();
            _url = _url.Replace("{clientId}", System.Uri.EscapeDataString(clientId));
            _url = _url.Replace("{operationId}", System.Uri.EscapeDataString(operationId));
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
